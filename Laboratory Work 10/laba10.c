...
int main(void) 
{
	...
	case 1: 
	{
		char f[] = "C:/Users/Artem/Desktop/Программирование/f.txt"; //Указание точного пути, где будет создаваться файл в процессе выполнения программы.
		int n = createA(f);
	...
	case 2: 
	{
		char S1[] = "C:/Users/Artem/Desktop/Программирование/S1.txt";
		char S2[] = "C:/Users/Artem/Desktop/Программирование/S2.txt";
		//createB(S1);
		funkB(S1, S2);
		displayB1(S1);
		displayB2(S2);
